...
function reducer(state, { type, payload }) {
  switch (type) {
    ...
    case ACTIONS.CHOOSE_OPERATION:
      ...
      if (state.currentOperand == null) { // to replace the operation type by diff operation click
        return {
          ...state,
    ...
    case ACTIONS.EVALUATE:
      ...
      return { // the oposite case of action or evaluation process
        ...state,
        overwrite: true,
